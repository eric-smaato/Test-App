...
public class AlertBannerSample extends ActionBarActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_alert_banner_sample);
		setTitleColor(Color.WHITE);
		getSupportActionBar().setBackgroundDrawable(
				new ColorDrawable(Color.parseColor("#3498db")));
		mAlertBanner = new AlertBanner(this);
		mAlertBanner.addAdListener(this);
		mAlertBanner.setAlertBannerStateListener(this);
		SharedPreferences prefs = AlertBannerSample.this.getSharedPreferences(
		...
		loadBanner.setOnClickListener(AlertBannerSample.this);
	}
