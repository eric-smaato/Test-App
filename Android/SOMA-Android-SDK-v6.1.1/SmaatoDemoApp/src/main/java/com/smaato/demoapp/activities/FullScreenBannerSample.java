...
public class FullScreenBannerSample extends ActionBarActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		loadBanner.setOnClickListener(FullScreenBannerSample.this);
		setTitleColor(Color.WHITE);
		getSupportActionBar().setBackgroundDrawable(
				new ColorDrawable(Color.parseColor("#3498db")));
		mFullScreenBanner = new FullScreenBanner(this);
		mFullScreenBanner.addAdListener(this);
		mFullScreenBanner.setAlertBannerStateListener(this);
		SharedPreferences prefs = FullScreenBannerSample.this.getSharedPreferences(Constants.COM_SMAATO_DEMOAPP,
