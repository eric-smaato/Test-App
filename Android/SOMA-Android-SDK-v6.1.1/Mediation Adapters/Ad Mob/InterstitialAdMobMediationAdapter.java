...
public class InterstitialAdMobMediationAdapter implements
	...
	public void requestInterstitialAd(Context context,
			...
			// Used format is : publisherId;AdSpaceId
			interstitial.getAdSettings().setPublisherId(
					Integer.parseInt(serverParameter.split("=")[0]));
			interstitial.getAdSettings().setAdspaceId(
					Integer.parseInt(serverParameter.split("=")[1]));
