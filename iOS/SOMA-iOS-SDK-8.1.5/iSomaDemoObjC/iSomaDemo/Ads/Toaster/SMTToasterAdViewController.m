...
#import "SMTToasterAdViewController.h"
#import <iSoma/iSoma.h>
#import "SMTAppSettings.h"

@interface SMTToasterAdViewController ()<SOMAAdViewDelegate>
@end

@implementation SMTToasterAdViewController
- (void)viewDidLoad{
    [super viewDidLoad];
}
